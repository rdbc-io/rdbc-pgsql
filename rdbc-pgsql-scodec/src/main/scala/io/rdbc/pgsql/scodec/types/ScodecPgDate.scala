...
object ScodecPgDate extends PgDate with ScodecPgType[LocalDate] with CommonCodec[LocalDate] {
  ...
  private val PgZero: LocalDate = LocalDate.of(2000, Month.JANUARY, 1)

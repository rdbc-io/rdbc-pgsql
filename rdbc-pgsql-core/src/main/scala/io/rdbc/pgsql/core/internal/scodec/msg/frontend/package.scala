...
package io.rdbc.pgsql.core.internal.scodec.msg
...
import ParamValuesCodec.paramValues
...
package object frontend {
  ...
  private[core] def pgFrontendMessage(implicit charset: Charset): _root_.scodec.Encoder[PgFrontendMessage] = {

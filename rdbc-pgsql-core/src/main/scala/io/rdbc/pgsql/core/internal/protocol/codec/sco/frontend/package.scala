...
import io.rdbc.pgsql.core.internal.protocol.codec.sco.ParamValuesCodec.paramValues
import io.rdbc.pgsql.core.internal.protocol.messages.backend.{PgKey, PgPid}
import io.rdbc.pgsql.core.internal.protocol.messages.frontend._

package object frontend {

  private[sco] def pgFrontendMessage(implicit charset: Charset): _root_.scodec.Encoder[PgFrontendMessage] = {
    new _root_.scodec.Encoder[PgFrontendMessage] {

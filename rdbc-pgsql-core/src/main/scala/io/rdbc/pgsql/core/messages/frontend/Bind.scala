...
case object NoReturnFields extends ReturnFieldFormats

case object AllBinary extends ReturnFieldFormats

case object AllTextual extends ReturnFieldFormats

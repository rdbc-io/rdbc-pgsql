...
private[typeconv] object PgInt4TypeConverter
  extends PartialTypeConverter[PgInt4] {

  val cls = classOf[PgInt4]

  def convert(any: Any): Option[PgInt4] = {
    IntTypeConverter.convert(any).map(PgInt4)
  }
}

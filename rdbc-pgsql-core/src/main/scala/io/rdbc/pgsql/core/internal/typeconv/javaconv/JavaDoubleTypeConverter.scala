...
private[typeconv] object JavaDoubleTypeConverter
  extends PartialTypeConverter[java.lang.Double] {
  val cls = classOf[java.lang.Double]

  def convert(any: Any): Option[lang.Double] = {
    DoubleTypeConverter.convert(any).map(double2Double)
  }
}

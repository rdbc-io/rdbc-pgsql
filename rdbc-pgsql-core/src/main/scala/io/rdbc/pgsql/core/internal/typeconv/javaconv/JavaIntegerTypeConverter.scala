...
private[typeconv] object JavaIntegerTypeConverter
  extends PartialTypeConverter[java.lang.Integer] {

  val cls = classOf[java.lang.Integer]

  def convert(any: Any): Option[lang.Integer] = {
    IntTypeConverter.convert(any).map(int2Integer)
  }
}
